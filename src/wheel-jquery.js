...
let renderWheelJquery = function(container) {
  console.log("RENDERING WHEEL JEQUERY to", container);
  $(container).momentus({
    u: 1,
    mass: 1000,
    wheelRatio: -1000,
    ...
    onChange: function(coords, velocity){
      $(container).find('div').each(function(i){
        ...
        $(this).css('transform', 'perspective(500px) rotate3d(1,0,0,'+angle+'deg) translate3d(0,0,158px)');
      });
    }
  });
};

export default renderWheelJquery
